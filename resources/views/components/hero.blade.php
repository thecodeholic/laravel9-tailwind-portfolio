        ...
        <div class="flex flex-wrap -mx-4">
            <div class="w-full lg:w-5/12 px-4">
                <div class="hero-content">
                    ...
                    >
                        My Name is Zura. <br/>
                        I am <span class="px-2 rounded-md text-amber-600">TheCodeholic</span>.
                    </h1>
                    <p class="text-base mb-8 max-w-[520px]">
                        ...
                        <a class="text-primary font-bold no-underline hover:underline underline-offset-2 decoration-2 decoration-amber-500" href="https://youtube.com/TheCodeholic" target="_blank">YouTube Channel</a>. <br>
                    </p>
