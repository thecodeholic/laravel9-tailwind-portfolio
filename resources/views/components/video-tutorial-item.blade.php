<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg overflow-hidden mb-10">
        ...
        <!-- ====== Video Section Start -->
        <section x-data="{ videoOpen: false}" class="bg-white">
            <div class="flex flex-wrap justify-center pt-3 -mx-4">
                <div class="w-full lg:w-10/12">
                    <div class="h-[200px] rounded-lg overflow-hidden relative z-20">
                        ...
                        <div
                            class="absolute top-0 left-0 w-full h-full flex items-center justify-center bg-primary bg-opacity-90 z-10">
                            <a
                                href="javascript:void(0)"
                                @click="videoOpen = true"
                                class=" flex items-center justify-center w-20 md:w-[100px] h-20 md:h-[100px] rounded-full bg-white text-primary absolute z-20 "
                            >
                        <span
